...
![Initial Joomla Enum]({{ site.baseurl }}/assets/images/office/jooma-enum.png)
...
![Wireshark Protocol Hierarchy Statistics]({{ site.baseurl }}/assets/images/office/Wireshark-stats.png)
...
![Wireshark Kerberos Pre-auth packet]({{ site.baseurl }}/assets/images/office/wireshark-kerb-preauth.png)
...
![Wireshark Kerberos Pre-auth cipher]({{ site.baseurl }}/assets/images/office/kerb-preauth-cipher.png)
...
![Joomla Administration Portal]({{ site.baseurl }}/assets/images/office/joomla-admin-panel.png)
...
![Joomla Theme Template Editor]({{ site.baseurl }}/assets/images/office/joomla-theme-editor.png)
...
![revshells Web Tool]({{ site.baseurl }}/assets/images/office/revshells-webtool.png)
...
![New Site Enumeration]({{ site.baseurl }}/assets/images/office/holo-web-enum.png)
...
![Job Application Submission]({{ site.baseurl }}/assets/images/office/jobapp-submission.png)
...
![Job Application Upload]({{ site.baseurl }}/assets/images/office/application-upload.png)
...
![Bloodhound Route to Target]({{ site.baseurl }}/assets/images/office/bhound-hhogan-to-target.png)



Next, the tester used bloodhound to plot out a path from the compromised users to the Domain Controller, `DC.OFFICE.HTB`
![Bloodhound Route to Target]({{ site.baseurl }}/assets/images/office/bhound-hhogan-to-target2.png)
...
![Bloodhound GPO Path]({{ site.baseurl }}/assets/images/office/bhound-gpo-path.png)
